...
const CALORIAS_TEXT = 'CALORIAS CALORIAS CALORIAS CALORIAS CALORIAS CALORIAS CALORIAS CALORIAS\u00a0'
const JUSTAS_TEXT = 'LAS JUSTAS LAS JUSTAS LAS JUSTAS LAS JUSTAS LAS JUSTAS LAS JUSTAS LAS JUSTAS\u00a0'
    ...
    const ctx = gsap.context(() => {
      ...
      ScrollTrigger.create({
        ...
        onEnter: () => {
          ...
          // Lanzar flicker en cada label con stagger
          labelTimelines = []
  ...
  return (
    ...
    <div className="hero-page">
      <nav className="hero-nav">
        <span className="brand-tag">#importa</span>
